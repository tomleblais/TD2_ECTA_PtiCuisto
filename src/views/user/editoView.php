...
<div class="main-container">
    <div class="main-container-left container">
        ...
        <div class="recipe-container">
            <?php foreach ($recipes as $recipe): ?>
                <a href="./index.php?action=recipeDetails&id=<?= $recipe->rec_id ?>">
                    <div class="recipe">
                        <div class="recipe-left">
                            <img src="./assets/img/recipes/<?= $recipe->rec_image ?>" alt="" class="recipe-image">
                        </div>
    ...
    <div class="main-container-right secondary container">
        <img src="./assets/img/edito.png" alt="" width="100" height="100" class="edito-image">
