...
class UserManager {
    ...
    public static function setHeader(int $type) {
        switch ($type) {
        case self::EDITER:
            $_SESSION['header'] = './src/views/user/headers/editerHeader.php';
            break;
        case self::ADMIN:
            $_SESSION['header'] = './src/views/user/headers/adminHeader.php';
            break;
        default:
            $_SESSION['header'] = './src/views/user/headers/userHeader.php';
        }
    }
